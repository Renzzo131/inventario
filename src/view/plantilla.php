...
if ($vista != './src/view/imprimir-movimiento.php'  && $vista != './src/view/imprimir-bienes.php' && $vista != './src/view/reporte-bienes.php' &&  $vista != './src/view/reporte-usuarios.php' &&  $vista != './src/view/reporte-ambientes.php' &&  $vista != './src/view/reporte-instituciones.php' &&  $vista != './src/view/reporte-movimientos.php') {
