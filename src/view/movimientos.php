...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?php BASE_URL?>?views=reporte-movimientos" class="btn btn-success"><i class="fa fa-file-excel"></i> Exportar Excel</a>
                <a href="<?php BASE_URL?>?views=imprimir-movimientos-general" class="btn btn-danger"><i class="fa fa-print"></i> Imprimir reporte</a>
