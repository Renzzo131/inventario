...
class vistaModelo
{
    protected static function obtener_vista($vista)
    {
        ...
        $palabras_permitidas_n1 = ['inicio', 'imprimir-movimiento', 'usuarios', 'nuevo-usuario', 'instituciones', 'nueva-institucion', 'ambientes', 'nuevo-ambiente', 'bienes',  'nuevo-bien', 'movimientos', 'nuevo-movimiento','reporte-bienes'];
